---
title: "How QWF Learns"
slug: "how-qwf-learns"
pillar: "open-playbook"
description: "*A living reference of the sources, methods, and disciplines Quietly Working Foundation uses to stay ahead... built for owner-operators and Executive Directors "
tags: ["how-to", "learning", "nonprofit-tech", "emerging-tech", "reference", "living-document"]
isHome: false
---
# How QWF Learns
...
| Source | Format | Why It Earns Its Slot |
|--------|--------|----------------------|
| [NTEN Connect](https://www.nten.org/publications) | Monthly newsletter + annual conference | The de facto professional association for nonprofit technologists. Vendor-agnostic. |
| [Community IT Innovators Podcast](https://communityit.com/podcast/) | Weekly podcast + monthly free webinars | Hands-down the most IT-practical source we've found. Microsoft 365, cybersecurity, cloud, AI policy... all contextualized for small nonprofits. |
| [Nonprofit Tech for Good](https://www.nptechforgood.com/) | Weekly newsletter + affordable certificate programs | Heather Mansfield's 15+ year track record. Digital fundraising and social media done right. |
| [Beth Kanter's Blog](https://bethkanter.org/) | Blog + "All Things AI" newsletter | The sector's most credible voice on generative AI adoption without hype. Co-authored *The Smart Nonprofit* with Allison Fine. |
| [The Chronicle of Philanthropy](https://www.philanthropy.com/) | Daily + print | ~350,000 nonprofit pros subscribe. Call it the Wall Street Journal of the nonprofit world. |
| [Candid Insights](https://blog.candid.org/) | Blog + news | Candid runs the 990 data infrastructure the sector runs on. |
| [Tech Impact](https://techimpact.org/) | Blog + workforce programs | Runs actual IT workforce training. Pragmatic, operator perspective. |
...
| Source | Cost | Why |
|--------|------|-----|
| [One Useful Thing](https://www.oneusefulthing.org/) by Ethan Mollick | Free | Single best source for operationalizing AI this month. Every essay includes experiments you can run. Wharton professor. No hype. |
| [Stratechery](https://stratechery.com/) by Ben Thompson | Free weekly + $150/yr daily | The most-cited tech analyst among operators. 12+ years of consistency. Strategic framing beats news. |
| [Exponential View](https://www.exponentialview.co/) by Azeem Azhar | Free + paid | The 3-5 year horizon. Cited by HBR and the FT. |
| [Import AI](https://importai.substack.com/) by Jack Clark | Free | Weekly. Co-founder of Anthropic writing at the frontier but still explaining for outsiders. |
| [The Pragmatic Engineer](https://newsletter.pragmaticengineer.com/) by Gergely Orosz | ~$15/mo | 500K+ readers. The "what's really happening inside tech companies" view even non-engineers benefit from. |
| [The Batch](https://www.deeplearning.ai/the-batch/) by Andrew Ng | Free | Weekly ML research and industry summary. Andrew Ng's credibility is unmatched in ML education. |
| [Latent Space](https://www.latent.space/) by swyx | Free | Written for AI engineers by AI engineers. Highest signal for technical practitioners. |
| [The Rundown AI](https://www.therundown.ai/) | Free | 2M+ subscribers. Daily 5-minute breadth. Pair with One Useful Thing for depth. |

**YouTube channels worth subscribing to:**

| Channel | What You Get |
|---------|--------------|
| [Andrej Karpathy](https://www.youtube.com/@AndrejKarpathy) | The gold standard. "Zero to Hero" series teaches neural networks from scratch. Former Tesla AI director, OpenAI founding member. |
| [AI Explained](https://www.youtube.com/@aiexplained-official) | Weekly research paper breakdowns. Calm, measured, researcher-aware. |
| [Two Minute Papers](https://www.youtube.com/@TwoMinutePapers) | 5-10 minute summaries of AI research. Dr. Károly Zsolnai-Fehér at TU Wien. |
| [Matt Wolfe](https://www.youtube.com/@mreflow) | AI tool reviews and weekly news. Entrepreneur lens... focuses on what you can use today. |
| [Wes Roth](https://www.youtube.com/@WesRoth) | Daily AI news and agent developments. Catches stories before mainstream press. |
| [Nate B. Jones](https://www.youtube.com/@NateBJones) | Strategic AI implications for product and operations leaders. 20-year product veteran. |
| [Cleo Abram](https://www.youtube.com/@CleoAbram) | Optimistic tech explainers. Rigorous sourcing, no doomscroll. |

**Podcasts worth the commute:**

| Podcast | Why |
|---------|-----|
| [Dwarkesh Podcast](https://www.dwarkeshpatel.com/) | Most pointed AI interviewer working. Extracts specifics where others get vague answers. |
| [Hard Fork](https://www.nytimes.com/column/hard-fork) (NYT) | Kevin Roose and Casey Newton. Skeptical but not cynical. Accessible for non-technical EDs. |
| [Last Week in AI](https://www.lastweekin.ai/) | Researcher hosts. Structural weekly coverage across research, industry, policy, ethics. |
| [No Priors](https://www.no-priors.com/) | Sarah Guo and Elad Gil interviewing AI founders, often pre-mainstream. |
| [Latent Space](https://www.latent.space/) | Best source on open-source AI specifically. |
...
| Source | Format | Why |
|--------|--------|-----|
| [Lenny's Newsletter](https://www.lennysnewsletter.com/) + Podcast | Free + paid | Former Airbnb PM interviewing operators. Unusually candid for the genre. |
| [Every.to](https://every.to/) | Daily bundle + podcast | Dan Shipper's *Chain of Thought* column is the flagship. Operator-authentic... the team ships AI products *and* writes about shipping them. |
| [Not Boring](https://www.notboring.co/) by Packy McCormick | Free weekly | Long-form strategy essays. Former lawyer, so explanations are clear. 250K+ subscribers. |
| [First Round Review](https://review.firstround.com/) | Free | Tactical operator playbooks on hiring, comp, management. Drawn from portfolio companies. No sponsored content. |
| [My First Million](https://www.mfmpod.com/) | Podcast | Sam Parr (built and sold The Hustle) and Shaan Puri. Trend-spotting and marketing tactics. |
| [Acquired](https://www.acquired.fm/) | Podcast | 3-4 hour deep dives on single companies. Best strategy history you can get for free. |
...
| Source | Why |
|--------|-----|
| [ByteByteGo](https://blog.bytebytego.com/) | System design made visual. Alex Xu is exceptional at explaining scale. |
| [Netflix TechBlog](https://netflixtechblog.com/) | Data pipelines, streaming infrastructure. |
| [Stripe Engineering](https://stripe.com/blog/engineering) | Payment systems, API design. Industry gold standard. |
| [Cloudflare Blog](https://blog.cloudflare.com/) | Networking, edge compute, security. Unusually readable. |
| [GitHub Engineering](https://github.blog/category/engineering/) | Git internals, Copilot infrastructure. |
| [TLDR Newsletter](https://tldr.tech/) | Daily 5-minute tech news digest. 750K+ readers. |
...
| Source | Why |
|--------|-----|
| [Corridor Crew](https://www.youtube.com/@CorridorCrew) | Working VFX artists showing actual tools and actual mistakes. AI film experiments that ship. |
| [Curious Refuge](https://curiousrefuge.com/) | Runs the largest AI-film community. Hosts festivals Hollywood now attends (WAiFF Cannes, AI on the Lot). |
| [The Futur](https://www.thefutur.com/) by Chris Do | Design business, brand strategy, client management. 25+ years in design leadership. |
| [MKBHD](https://www.youtube.com/@mkbhd) + [Waveform](https://www.youtube.com/@WVFRM) | Turned down 7-figure crypto sponsorships to protect editorial independence. Tells you what you need to know about the tech review space. |
| [Fireship](https://www.youtube.com/@Fireship) | 100-second programming explainers. Great "keep current" diet for small teams. |
...
| Source | Why |
|--------|-----|
| [Krebs on Security](https://krebsonsecurity.com/) | Original investigative cybercrime reporter. Often breaks stories 72 hours before mainstream. |
| [Schneier on Security](https://www.schneier.com/) | 30+ years of systems-thinking security writing. Author of *Applied Cryptography*. |
| [Risky Business](https://risky.biz/) | Required listening for working security pros. Skeptical, informed, funny. |
| [SANS NewsBites](https://www.sans.org/newsletters/newsbites/) | Bi-weekly curated security news with expert commentary. Free. Great for small-org CISOs. |
| [Smashing Security](https://www.smashingsecurity.com/) by Graham Cluley | Accessible security news great for non-technical staff training. |
...
| Source | Why |
|--------|-----|
| [A Bit of Optimism](https://simonsinek.com/podcast/) by Simon Sinek | Leadership, meaning, purpose. Spiritually open without being religious. |
| [The Carey Nieuwhof Leadership Podcast](https://careynieuwhof.com/mypodcast/) | Church + business leadership. Interviews span Seth Godin, Adam Grant, Patrick Lencioni. Rare source that takes both faith and organizational rigor seriously. |
| [Praxis](https://www.praxislabs.org/) | Redemptive entrepreneurship. Building ventures from a faith perspective. |
| [Farnam Street](https://fs.blog/) by Shane Parrish | Mental models, timeless thinking. *The Knowledge Project* podcast is a goldmine. |
...
| Source | Why We're Careful |
|--------|-------------------|
| a16z Podcast and Future | Useful for themes but increasingly a portfolio-marketing channel. Treat as industry PR, not journalism. |
| High Scalability | Historic archive is gold. Current cadence inconsistent. Reference only. |
| Most "Top AI Tools" newsletters | Many are affiliate-driven. Fine as appetizer. Not main meal. |
| Lex Fridman (as a complete feed) | Quality varies wildly by guest. Subscribe selectively, episode by episode. |
| LinkedIn AI influencers | Algorithmic incentive equals hype. Almost always lower signal than the same person's Substack. |
...
1. **[NTEN Connect](https://www.nten.org/publications)** ... community and sector
2. **[Community IT Innovators Podcast](https://communityit.com/podcast/)** ... weekly IT practical
3. **[One Useful Thing](https://www.oneusefulthing.org/)** ... practical AI
4. **[Stratechery free weekly](https://stratechery.com/)** ... strategic framing
5. **[The Pragmatic Engineer](https://newsletter.pragmaticengineer.com/)** ... how tech orgs actually work
6. **[Hard Fork](https://www.nytimes.com/column/hard-fork)** ... accessible weekly tech news
7. **[Krebs on Security](https://krebsonsecurity.com/)** ... security for free
8. **[Beth Kanter](https://bethkanter.org/)** ... nonprofit AI credibility anchor
...
If you're reading this and a source is dead, drifting, or missing something obviously better... tell us. `tig@quietlyworking.org`. Send the link. We'll test it and either add it or tell you why we won't.
